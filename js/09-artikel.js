...
const uuData = {
    ...
    'uu11-2010': {
        ...
        abstrak: `Undang-Undang ini adalah undangan bagi kita semua untuk aktif mengenali dan mencintai warisan budaya bangsa. Cagar budaya merupakan kekayaan budaya bangsa sebagai wujud pemikiran dan perilaku kehidupan manusia yang penting artinya bagi pemahaman dan pengembangan sejarah, ilmu pengetahuan, dan kebudayaan.

Negara hadir sebagai pelindung dan fasilitator — mengatur kriteria penetapan cagar budaya, menyelenggarakan Register Nasional, serta menjamin pelindungan hukum agar benda-benda bernilai tinggi seperti wayang kulit kuno tidak rusak, hilang, atau berpindah tangan secara tidak semestinya. Setiap warisan yang kita jaga hari ini adalah hadiah tak ternilai untuk generasi yang akan datang.`,
        materi: [
            '✦ Kriteria & Cara Penetapan Cagar Budaya',
            '✦ Register Nasional Cagar Budaya (Pencatatan Resmi)',
            '✦ Pelindungan: Penyelamatan, Pengamanan, Zonasi, Pemeliharaan',
            '✦ Pengembangan & Pemanfaatan Cagar Budaya',
            '✦ Penemuan dan Pendaftaran Cagar Budaya oleh Masyarakat',
            '✦ Pemilikan, Penguasaan & Pengalihan Hak',
            '✦ Tugas & Wewenang Pemerintah Pusat dan Daerah',
            '✦ Pendanaan, Kompensasi & Insentif bagi Penjaga Warisan',
            '✦ Pengawasan & Ketentuan Hukum Perlindungan',
        ]
    },
    ...
    'perpres78-2007': {
        ...
        abstrak: `Ini adalah bukti nyata komitmen Indonesia bersama komunitas dunia untuk memastikan warisan budaya takbenda — seperti seni pertunjukan wayang, tradisi lisan, pengetahuan lokal, dan upacara adat — tetap hidup dan berdenyut dari generasi ke generasi.

Dengan meratifikasi Konvensi UNESCO 2003 melalui Perpres ini, Indonesia berkomitmen untuk membuat inventaris nasional warisan budaya takbenda, menjalankan program pelestarian yang nyata, dan berbagi pengetahuan dengan komunitas internasional. Indonesia menjadi bagian dari gerakan global yang percaya bahwa kekayaan budaya adalah milik umat manusia yang harus dijaga bersama.`,
        materi: [
            '✦ Pengesahan Konvensi UNESCO 2003 secara resmi',
            '✦ Inventarisasi Nasional Warisan Budaya Takbenda',
            '✦ Program Pelindungan & Pelestarian Aktif',
            ...
            '✦ Partisipasi Komunitas, Kelompok & Individu',
        ]
    },
    ...
    'pp1-2022': {
        ...
        abstrak: `Peraturan Pemerintah ini adalah panduan teknis bagi kita semua — masyarakat dan pemerintah — untuk bahu-membahu dalam mendata dan merawat cagar budaya nasional. Sebagai aturan pelaksana dari UU No. 11 Tahun 2010, PP ini mengatur secara konkret mekanisme pendaftaran, penetapan, pengelolaan, dan pemeliharaan cagar budaya, termasuk wayang-wayang bersejarah yang tersimpan di museum.

PP ini juga memberikan perlindungan terhadap Objek yang Diduga Cagar Budaya (ODCB), memastikan benda-benda berharga tidak terabaikan sebelum sempat didaftarkan. Pendanaan pelestarian menjadi tanggung jawab bersama antara Pemerintah Pusat, Pemerintah Daerah, dan masyarakat — sebuah gotong royong budaya untuk kemajuan bangsa.`,
        materi: [
            '✦ Mekanisme Pendaftaran ke Register Nasional',
            '✦ Perlindungan Objek Diduga Cagar Budaya (ODCB)',
            '✦ Pelestarian: Pelindungan, Pengembangan, Pemanfaatan',
            '✦ Pengelolaan Kawasan Cagar Budaya',
            '✦ Insentif & Kompensasi bagi Pemilik/Pengelola',
            '✦ Pendanaan Bersama: Pusat – Daerah – Masyarakat',
            '✦ Pengawasan & Koordinasi Antar-Lembaga',
        ]
    },
    ...
    'uu5-2017': {
        ...
        abstrak: `Undang-Undang ini adalah seruan dan amanat bagi seluruh elemen bangsa untuk tidak hanya melindungi, tetapi juga mengembangkan, memanfaatkan, dan membina kebudayaan nasional agar semakin tangguh dan berdaya. Negara memajukan Kebudayaan Nasional Indonesia di tengah peradaban dunia dan menjadikan Kebudayaan sebagai investasi untuk membangun masa depan bangsa.

UU ini secara eksplisit menyebut wayang sebagai salah satu objek pemajuan kebudayaan. Pasal 4 menegaskan bahwa pemajuan kebudayaan bertujuan memperkuat identitas bangsa. Ini bukan hanya soal menjaga masa lalu — ini soal membangun bangsa yang beridentitas kuat dan berwibawa di mata dunia.`,
        materi: [
            '✦ Objek Pemajuan Kebudayaan (termasuk Wayang)',
            '✦ Pelindungan & Pengembangan Kebudayaan Nasional',
            '✦ Pemanfaatan & Pembinaan Kebudayaan',
            '✦ Pemajuan Kebudayaan: Memperkuat Identitas Bangsa',
            '✦ Rencana Induk Pemajuan Kebudayaan',
            '✦ Sistem Informasi Kebudayaan Nasional',
            '✦ Pendanaan & Peran Pemerintah Daerah',
            '✦ Peran Serta Masyarakat dalam Pemajuan Kebudayaan',
        ]
    },
    ...
    'uu5-2017-diplomasi': {
        ...
        jenis: 'Undang-Undang Republik Indonesia',
        tentang: 'Pemajuan Kebudayaan: Diplomasi Budaya & Kebanggaan di Mata Dunia',
        berlaku: 'Mulai berlaku: 29 Mei 2017',
        sumber: 'https://peraturan.bpk.go.id/Details/37642/uu-no-5-tahun-2017',
        unduh: 'https://peraturan.bpk.go.id/Download/26736/UU%20No%205%20Tahun%202017.pdf',
        abstrak: `Pasal 35 UU No. 5 Tahun 2017 mengamanatkan bahwa pemerintah wajib melakukan diplomasi budaya untuk memperkuat posisi Indonesia di forum internasional dan menjaga citra bangsa. Ini adalah panggilan untuk proaktif — bukan menunggu klaim, tetapi mengangkat budaya kita ke pentas dunia dengan bangga.

Pasal 43 huruf i & j secara khusus mendorong kerja sama internasional di bidang kebudayaan: pertukaran budaya, kolaborasi artistik lintas batas, dan partisipasi aktif dalam forum budaya dunia. Bagi wayang, pasal-pasal ini adalah landasan hukum untuk membawa seni adiluhung kita sebagai duta bangsa — membangun persahabatan dan kebanggaan bersama di antara bangsa-bangsa.`,
        materi: [
            ...
            '✦ Soft Power Budaya untuk Kebanggaan Nasional',
            '✦ Kolaborasi Artistik & Pertunjukan Internasional',
        ]
    }
};
